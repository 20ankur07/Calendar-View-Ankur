...
function action(name, options = {}) {
  ...
  const handler = __name(function actionHandler(...args) {
    ...
    if (options.implicit) {
      ...
      const storyRenderer = preview == null ? void 0 : preview.storyRenders.find(
        (render) => render.phase === "playing" || render.phase === "rendering"
      );
      if (storyRenderer) {
        const deprecated = !((_a = globalThis == null ? void 0 : globalThis.FEATURES) == null ? void 0 : _a.disallowImplicitActionsInRenderV8);
...
//# sourceMappingURL=chunk-7BT5243B.js.map
